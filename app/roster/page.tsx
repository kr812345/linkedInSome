  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 pt-24 sm:pt-32 flex-1 gap-8">
      <div className="flex flex-col pl-4 sm:pl-8 lg:pl-25">
        <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-text text-shadow-md text-shadow-[#ff2f00]">
            ...
            <div className="relative mb-4 flex w-full self-center flex-col items-center px-4">
              <div className="flex gap-2">
                <img
                  src={image}
                  alt="Uploaded"
                  className="max-w-full mx-auto h-60 sm:h-80 lg:h-120 z-0 rounded-lg object-contain"
                />
                <div className="px-2 py-2 right-0 top-0 hover:cursor-pointer">
                  <RiCloseLargeLine className="" onClick={handleClose} />
                </div>
              </div>
              <motion.button
                animate={{}}
      ...
      {/* Improve Option */}
      {(
        <div className=" bottom-0 left-0 right-0 bg-bg-surface p-4 border-t border-bg-elevated mt-4 sm:mt-8 rounded-b-lg flex justify-center">
          <Link
            href="/userNiche"
            className="inline-block border-2 border-[#ff2f00] hover:rounded-md px-4 py-2 bg-primary text-text-primary rounded-full text-sm sm:text-base hover:shadow-[0_0_10px_2px_#ff2f00] transition-all"
          >
