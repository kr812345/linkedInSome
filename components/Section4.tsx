            ...
            <div className='relative min-h-screen px-6 sm:px-12 lg:px-25 py-16 lg:py-40 flex flex-col lg:grid lg:grid-cols-2 gap-12 text-white'>
                ...
                <div className='flex flex-col items-center lg:items-start text-center lg:text-left'>
                    <div>
                        ...
                        <button onClick={() => (redirect('/'))} className='rounded-full px-3 py-2 mt-6 bg-[#ff2f00] shadow-[#ff2f00] drop-shadow-lg drop-shadow-y-[#ff2f00] shadow-md font-semibold'>Join Waiting List</button>
                    </div>
                </div>
