...
const Section4 = () => {
  ...
  return (
    <>
    <div className='relative min-h-screen px-25 py-40 grid grid-cols-2 text-white'>
        {/* left */}
        <div className='flex  flex-col items-center '>
            <div>
            <h1 className='text-6xl font-bold text-shadow-[#ff2f00] text-shadow-md'>How It Works ?</h1>
        ...
        <div className='grid grid-cols-2'>
            {items.map((i)=>(
                <div key={i.i}>
                    <h1 className='text-8xl text-[#7f7f7f] font-bold font-mono'>{i.i}</h1>
                    <h2 className='text-4xl text-[#e5e5e5] mt-4 font-bold'>{i.title}</h2>
